...
gye = LINE('Evitb8AnHgKRldDL0pR6.EykXWEgtcmN7T7shszPO9G.ljKZnEWaID9dYZk/RoyaNegbSDif4vM9yytm/TxBR54=')
gye.log("Auth Token : " + str(gye.authToken))
channelToken = gye.getChannelResult()
gye.log("Channel Token : " + str(channelToken))

ais = LINE('EvWcXPJlTen1DNJUtJ63.E4KE689L0L+bMP4eiSs3KW.RSrMLiyCVDbal5yFruzhkSTnVUpf3vSmeOCcYYX+aLI=')
ais.log("Auth Token : " + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Channel Token : " + str(channelToken))

ki2 = LINE('EvqLVBqyoa0VbwSK5a58.O+l81HDaDwbvVwAIvhfaAa.V3y0g7PBOk5//Jc7MY7a7J+dVEeK+cN7GMZdqMlpOVs=')
ki2.log("Auth Token : " + str(ki2.authToken))
channelToken = ki2.getChannelResult()
ki2.log("Channel Token : " + str(channelToken))

ki3 = LINE('EvyMsXqRHpb84YHDeeia.zR34G6W8FpmE45NAA9x2wG.ZoJSlIRzHIhFD6Usgr/zhF7LMkEtViF82aHpzNtT4RQ=')
ki3.log("Auth Token : " + str(ki3.authToken))
channelToken = ki3.getChannelResult()
ki3.log("Channel Token : " + str(channelToken))

ki4 = LINE('Ev5nL7KwzONKBuUK4Yxa.NHbJJsI1BVgeG9s/VkXScG.k/JOBR4QaiJdhac4tmu4/4KF4/opDD/EgLQ6EfHqn8U=')
ki4.log("Auth Token : " + str(gye.authToken))
channelToken = ki4.getChannelResult()
ki4.log("Channel Token : " + str(channelToken))

ki5 = LINE('EvoUTyQYEnQuhdZlnbY4.7njosUn84Z61Msdkc+LyDa.mw805qCoFOPE18+bEcNcwNptOcuhsEL5+E5Kcr+qGIs=')
ki5.log("Auth Token : " + str(gye.authToken))
channelToken = ki5.getChannelResult()
ki5.log("Channel Token : " + str(channelToken))

ki6 = LINE('EvGUfRzdimXrZm1Zu4y4.OfuyEYOoLrzTht1dSA0/ja.ls9O8DpodxH5J06M/64rpFxOtnueSovlgaGu23sBDmo=')
ki6.log("Auth Token : " + str(gye.authToken))
channelToken = ki6.getChannelResult()
ki6.log("Channel Token : " + str(channelToken))

ki7 = LINE('EvKaw4ne1KGlUfiVfS60.3vA8S4h3GRF8Z8zhoqMgqa.u/Uk1PKu+vlfB+BDNvyPMXH8uhxgzL+ChbEcUfsI7Fw=')
ki7.log("Auth Token : " + str(gye.authToken))
channelToken = ki7.getChannelResult()
ki7.log("Channel Token : " + str(channelToken))

ki8 = LINE('EvqYlGhZSXfUHf2gWlmc.1NROJDyABxlw89QRLkRcpa.t2VB3Y1CZfwsZjC3OpbL5q6OSoheBsdTBB6zF2+qRaw=')
ki8.log("Auth Token : " + str(gye.authToken))
channelToken = ki8.getChannelResult()
ki8.log("Channel Token : " + str(channelToken))

ki9 = LINE('EvTFgFwJ1S0Sys6q0rre.bJmHHplKDuoyVOtab17v+G.8qD7ek0JzNgS3pCW1dlxTjmUS5cGeFLUp7gPXRjMLhY=')
ki9.log("Auth Token : " + str(gye.authToken))
channelToken = ki9.getChannelResult()
ki9.log("Channel Token : " + str(channelToken))

ki10 = LINE('Ev6vKK0t2JGWO4R1E3D6.+j+f5zYS7MVSDG2kRrAO5G.NtKiviCjTpeXJD5Ai/p8YsvfY3NEYZL51hwnMp3jWmE=')
ki10.log("Auth Token : " + str(gye.authToken))
channelToken = ki10.getChannelResult()
ki10.log("Channel Token : " + str(channelToken))

ki11 = LINE('EvMkeG1J7urxYiz9lhX5.vwshR3GLKStojblKOkkFnq.ROGkZ7W9lNOI1dR6gtBYf81JvNTXI+Q3RhSYj+HmOng=')
ki11.log("Auth Token : " + str(gye.authToken))
channelToken = ki11.getChannelResult()
ki11.log("Channel Token : " + str(channelToken))

ki12 = LINE('EvlqzSgWVGA5sBgKWIR9.KUGjTdtBgn4t0ikv8BWNYq.fdEV7MEmR0P3WryOOxlqKkbZgscMSSnp4VJ1aNQKKLg=')
...
creator = ["u7982b1c1e19308c9fbb7b487499a68f6"]
Owner = ["u7982b1c1e19308c9fbb7b487499a68f6"]
admin = ["u7982b1c1e19308c9fbb7b487499a68f6"]
