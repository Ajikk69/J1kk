...
gye = LINE('EweH1xCV35ffSNo62QK0.oBqHvVAceEVgCumneQEvGa.TtrlA9JcpzoG1MsCcFrQWO6WDdsgNigPzr9CcC/ZzYY=')
gye.log("Auth Token : " + str(gye.authToken))
channelToken = gye.getChannelResult()
gye.log("Channel Token : " + str(channelToken))

ais = LINE('Ew5gtast4Uqwu3EikWOe.91QiLdxAJ3v2j8EQGkz2+G.+09KbKTuVb/pXwHWXmIEf6STIVLyCOf9OijoHwzW69k=')
ais.log("Auth Token : " + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Channel Token : " + str(channelToken))

ki2 = LINE('EwQBRudV1xGB2NgUYux7.G8CMbZWitmrZ9TY0SSG6nW.5LCOMsb5FLJqZS7iuV3coeaQVQEwPks8udFe24yidUo=')
...
creator = ["u0b192c7a2687f47fe70f24e260634e52"]
