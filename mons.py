...
gye = LINE('EweZ20vWJm5Li3hyBqa4.AdtB4AacKQUPSc0C26yCra.qrka9AyJS+vnCVts6oUHc8kNLHAFjGRRUejXj46hXP0=')
gye.log("Auth Token : " + str(gye.authToken))
channelToken = gye.getChannelResult()
gye.log("Channel Token : " + str(channelToken))

ais = LINE('EwfhOnfBUPxClaXlxNsa.nXyLJukcsbFE7pqvirFxAG.n6hhMZaON5yOypoGl7u3YPml7Qgvpp7BEfxdbPjHdEw=')
ais.log("Auth Token : " + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Channel Token : " + str(channelToken))

ki2 = LINE('Ewb8Cqoia3b6HzT1PHxe.sFA3qpOMx93TzMuUgdpjZG.bEuFwIVxpldGE1iCy9BbqikdlfAqbKZMytBzomRi+Oo=')
ki2.log("Auth Token : " + str(ki2.authToken))
channelToken = ki2.getChannelResult()
ki2.log("Channel Token : " + str(channelToken))

ki3 = LINE('EwzXAMn1VEYvbj9IafHe.NXBzQSs27AbcX+4QQsMMZG.lxCOzsUhSTM0eQ9PAX09cQ7JPknWcTrESRGPrzCR94M=')
ki3.log("Auth Token : " + str(ki3.authToken))
channelToken = ki3.getChannelResult()
ki3.log("Channel Token : " + str(channelToken))

ki4 = LINE('Ewq9zLIqZ8kBuI5Uw1k4.lsuliQbRFyFn/N6v3aOBfa.4PXmbGcwGupyjGBUzbTOrQao9b5WY6bP8oWdnAeDy8E=')
ki4.log("Auth Token : " + str(gye.authToken))
channelToken = ki4.getChannelResult()
ki4.log("Channel Token : " + str(channelToken))

ki5 = LINE('EwUkiSPHVHISEHTsHpX0.uBPYqXPWza/mmc0eBvTvea.nnjAfi74mHBI2S7Na79aSuSPSHzVeoNs95jWoRKlOHA=')
ki5.log("Auth Token : " + str(gye.authToken))
channelToken = ki5.getChannelResult()
ki5.log("Channel Token : " + str(channelToken))

ki6 = LINE('EwcuSUJvzdihCcZniGva.LhW7Jy0E3dSQXyZp//eIEG.c2mX1SLte+Dz5FqPacyehHOXXwCKOYreLe5cnN5FSRA=')
ki6.log("Auth Token : " + str(gye.authToken))
channelToken = ki6.getChannelResult()
ki6.log("Channel Token : " + str(channelToken))

ki7 = LINE('Ews6IxJ0tGjXGV0q2he0.3vA8S4h3GRF8Z8zhoqMgqa.hq1otpvBTm/AwJGpvOTGnZseyVd8rzMMI8KN5aCyGJo=')
ki7.log("Auth Token : " + str(gye.authToken))
channelToken = ki7.getChannelResult()
ki7.log("Channel Token : " + str(channelToken))

ki8 = LINE('EwM39bnSFfZDFb03TJG4.OfuyEYOoLrzTht1dSA0/ja.cJQ2itxgskCQADarGaKBw2fft9weTbmIKBzo8GfLti0=')
ki8.log("Auth Token : " + str(gye.authToken))
channelToken = ki8.getChannelResult()
ki8.log("Channel Token : " + str(channelToken))

ki9 = LINE('EwdlxO4Kib7IGkwTLPAe.91QiLdxAJ3v2j8EQGkz2+G.8xQT+EBa+8fs3xMvFYi5/qYu076jM2cfdVwwm1IWPoU=')
ki9.log("Auth Token : " + str(gye.authToken))
channelToken = ki9.getChannelResult()
ki9.log("Channel Token : " + str(channelToken))

ki10 = LINE('EwQBRudV1xGB2NgUYux7.G8CMbZWitmrZ9TY0SSG6nW.5LCOMsb5FLJqZS7iuV3coeaQVQEwPks8udFe24yidUo=')
ki10.log("Auth Token : " + str(gye.authToken))
channelToken = ki10.getChannelResult()
ki10.log("Channel Token : " + str(channelToken))

ki11 = LINE('EwtWzdBsj2SL1gKbqH45.ep709O5LXIYYLPrXIrlpzq.pSjQcZqcuQQ2vAMAqYuH7jg22vAMx6AR8q37ASE+JNY=')
ki11.log("Auth Token : " + str(gye.authToken))
channelToken = ki11.getChannelResult()
ki11.log("Channel Token : " + str(channelToken))

ki12 = LINE('EwsmfYKqAg4b42cp2wL4.hBhgAWbNpjHSGLDl1L50Pa.4YyRKURTa5/vLqpTv/UEwa2G/JiArq8NzH/0ucF+v64=')
...
creator = ["u6834dbe1a00292aba9b02d1cdba61c44"]
Owner = ["u6834dbe1a00292aba9b02d1cdba61c44"]
admin = ["u6834dbe1a00292aba9b02d1cdba61c44"]
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "u0b192c7a2687f47fe70f24e260634e52")
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u0b192c7a2687f47fe70f24e260634e52"
...
#=======================================================================================
                       ...
                       for target in targets:
                           try:
                               ...
                               random.choice(GUE).sendMessage(msg.to,"Error")
#-------------------------------------------------------------------------------
...
#==========                      
                    ...
                    if op.param2 in admin:
                        ...
                        random.choice(KAC).sendMessage(op.param1,"Duh duh kebelet boker!!")
